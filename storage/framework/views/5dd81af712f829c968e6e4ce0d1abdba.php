...
<fieldset>
<legend class="frm_hidden"><img   src="<?php echo e(asset('images/request-quote.png')); ?>"  /></legend>
...
<div id="frm_field_87_container" class="frm_form_field form-field  frm_required_field frm_top_container">
    <label for="field_i9tb7o" class="frm_primary_label">Interested In:
			...
			<option value="<?php echo e($slidder->title); ?>" class="">
			<?php echo e($slidder->title); ?>	</option>
...
<img  style="display: none"    class="display_data" src="<?php echo e(asset('images/ajax_loader.gif')); ?>" alt="Sending">
...
<?php /**PATH /home/itwtech2/public_html/ay_website/resources/views/form.blade.php ENDPATH**/ ?>