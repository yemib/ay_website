...
<meta name="abstract" content="<?php echo e(config('app.name')); ?>">
...
<link rel="shortcut icon" href="<?php echo e($logo->image); ?>" >
...
<link rel="revision" href="homepage">
    ...
    <!-- Chrome Icons -->
    <link rel="icon" sizes="192x200" href="<?php echo e($logo->image); ?>">

    <!-- Safari Icons -->
    <link rel="apple-touch-icon" href="<?php echo e($logo->image); ?>">
    
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo e($logo->image); ?>">
    
    


    <!-- IE Icons -->
    <meta name="msapplication-square70x70logo" content="<?php echo e($logo->image); ?>">
    <meta name="msapplication-square150x150logo" content="<?php echo e($logo->image); ?>">
    <meta name="msapplication-wide310x150logo" content="<?php echo e($logo->image); ?>">

    <link rel="stylesheet" media="all" href="<?php echo e(asset('css/bootstrap.css')); ?>">
    <link rel="stylesheet" media="all" href="<?php echo e(asset('css/css_xehN6l-UDXBDDeL3m-7PjuzZHfNwm6DNouf8p_l1wNI.css')); ?>">

<link rel="stylesheet" media="all" href="<?php echo e(asset('css/slick.css')); ?>">
<link rel="stylesheet" media="all" href="<?php echo e(asset('css/solid.css')); ?>">
<link rel="stylesheet" media="all" href="<?php echo e(asset('css/regular.css')); ?>">
<link rel="stylesheet" media="all" href="<?php echo e(asset('css/brands.css')); ?>">
<link rel="stylesheet" media="all" href="<?php echo e(asset('css/css_eSC7rx2DIDcAXX-bT37EvASjN-S0Cam2lBia1h20ZxE.css')); ?>">
<link rel="stylesheet" media="all" href="<?php echo e(asset('css/css.css')); ?>">
<link rel="stylesheet" media="all" href="<?php echo e(asset('css/general.css')); ?>">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">   

<script src="<?php echo e(asset('js/js_znOsrOG_a4RIy29bHWrpzo8AGWXErWtudTd2wLjLQWM.js')); ?>"></script>
...
<a href="tel:<?php echo e($contact->phone1); ?>" data-organic="<?php echo e($contact->phone1); ?>" data-metro="<?php echo e($contact->phone1); ?>" data-display="<?php echo e($contact->phone1); ?>" data-paid="<?php echo e($contact->phone1); ?>" class="phone"><span class="number"><?php echo e($contact->phone1); ?></span></a>
  ...
  <span class="location-block__phone">
    <i class="fa fa-phone"></i> 
<a href="tel:<?php echo e($contact->phone2); ?>" data-organic="<?php echo e($contact->phone2); ?>" data-metro="<?php echo e($contact->phone2); ?>" data-display="<?php echo e($contact->phone2); ?>" data-paid="<?php echo e($contact->phone2); ?>" class="phone"><span class="number"><?php echo e($contact->phone2); ?></span></a>
    ...
    <div id="header__bottom">
      <div class="layout-container">
        <!-- logo area --->
        <a id="logo" name="Home" href="/"   style="background-image: url(<?php echo e($logo->image); ?>)">
...
<ul class="menu menu-level-0" id="mega-menu">
  ...
  <li class="menu-item no-children">
    <a href="/page/<?php echo e($page->id); ?>/<?php echo e($page->title); ?>" data-drupal-link-system-path="node/23451"><?php echo e($page->title); ?></a>
  ...
  <div id="footer" class="footer">
    ...
    <div id="block-haveaquestionwereheretohelp" class="block block-content-f7477de4-af4d-4125-8775-7873cdd51d9b">
      ...
      <h3>Have a question???? We're here to help</h3>
            ...
            <div class="clearfix text-formatted field field--name-field-markup-body field--type-text-long field--label-hidden field__item"><div class="footer-contact">Call Corporate Customer Service: <a href="tel: <?php echo e($contact->phone1); ?>"> <?php echo e($contact->phone1); ?>  </a></div>
<div class="footer-contact">Call to Find a Location: <a href="tel:<?php echo e($contact->phone2); ?>">   <?php echo e($contact->phone2); ?>  </a></div>
...
<nav role="navigation" aria-labelledby="block-footer-menu" id="block-footer" class="block system-menu-block-footer block-menu navigation menu--footer">
  ...
  <h3 id="block-footer-menu">Discover More</h3>
        ...
        <a href="/page/<?php echo e($allpages->id); ?>/<?php echo e($allpages->title); ?>"><?php echo e($allpages->title); ?></a>
              </li>
...
<div id="block-socialmedialinks" class="block tmt-social-media">
	...
	<li><a href="https://www.facebook.com/<?php echo e($contact->facebook); ?>" class="icon--social"><i class="fa fa-facebook"></i><span class="visually-hidden">Facebook</span></a></li>
	
	
	
	<li><a href="https://twitter.com/<?php echo e($contact->twitter); ?>" class="icon--social"><i class="fa fa-twitter"></i><span class="visually-hidden">Twitter</span></a></li>
	
	
	<li><a href="https://plus.google.com/<?php echo e($contact->google); ?>" class="icon--social"><i class="fa fa-google-plus-circle"></i><span class="visually-hidden">Google Plus</span></a></li>
	
	<li><a href="https://www.pinterest.com/<?php echo e($contact->pinterest); ?>" class="icon--social"><i class="fa fa-pinterest-p"></i><span class="visually-hidden">Pinterest</span></a></li>
	
	
	<li><a href="https://www.youtube.com/user/<?php echo e($contact->youtube); ?>" class="icon--social"><i class="fa fa-youtube-square"></i><span class="visually-hidden">YouTube</span></a></li>
	
	
	<li><a href="https://www.linkedin.com/company/<?php echo e($contact->linkedin); ?>" class="icon--social"><i class="fa fa-linkedin-square"></i><span class="visually-hidden">LinkedIn</span></a></li>
	
	
	<li><a href="https://www.instagram.com/<?php echo e($contact->instagram); ?>/" class="icon--social"><i class="fa fa-instagram"></i><span class="visually-hidden">Instagram</span></a></li>
    ...
    <div id="block-copyright" class="block block-content-96cd0c35-09b8-427e-b3e6-e06ca0d1e9eb">
            ...
            <p>Copyright 2021 <?php echo e(config('app.name')); ?> | All Rights Reserved · </p>
...
<a href="tel: <?php echo e($contact->phone1); ?>"  class="phone"> <span class="glyphicon glyphicon-phone">  </span>  <span class="">Call</span> <span class="desktop-label"><span class="number"> <?php echo e($contact->phone1); ?></span></span></a>
      ...
      <div class="">
        ...
        <a href="tel: <?php echo e($contact->phone2); ?>" class="phone"><span class="glyphicon glyphicon-phone">  </span> <span class="desktop-label"><span class="number"> <?php echo e($contact->phone2); ?></span></span></a>
...
<script src="<?php echo e(asset('js/js_RyMBFrMzqsk2dF5cxG_dtHVCTBQnxgBusTUM0b78pR8.js')); ?>"></script>
<script src="<?php echo e(asset('js/jquery-1.11.3.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/bootstrap.js')); ?>"></script>

  

<div style="width:0px; height:0px; display:none; visibility:hidden;" id="batBeacon0.6382129043213013"><img style="width:0px; height:0px; display:none; visibility:hidden;" id="batBeacon0.39623005093622" alt="" src="<?php echo e(asset('img/0.txt')); ?>" width="0" height="0"></div>
...
<div style="display: none; visibility: hidden;">
<img style="border-style:none;" alt="" src="<?php echo e(asset('img/a.txt')); ?>" width="1" height="1">
</div>
...
</html><?php /**PATH /home/itwtech2/public_html/ay_website/resources/views/layouts/index.blade.php ENDPATH**/ ?>