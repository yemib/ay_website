...
?>
	    ...
	    <li data-target="#carousel1" data-slide-to="{{$i}}" class="  @if($i==1) active  @endif"></li>
	  ...
	  <?php    $count  = 1 ?>
    @foreach($select_slide as $sliders)
    
	    <div class="item @if($count==1) active  @endif"   style="">
...
<article class="moving-service featured-service">
  ...
  <div class="card card--circle-image">
    <div class="card-inner">
      <div class="card-content">
        ...
        <h4 id="card-title-1">
            <div class="field field--name-field-serv-display-name field--type-string field--label-hidden field__item"> {{ $services->title}} </div>
      </h4>
  ...
  <div class="panel background--black" id="panel--51">
            ...
            <div class="field field--name-field-panel-bg-image field--type-entity-reference field--label-hidden field__item"><div class="banner-image banner-background" style="background-image:url('{{ $logo->image }}');">
</div></div>
...
<a href="tel:{{  $contact->phone1 }}" data-organic="{{  $contact->phone1 }}" data-metro="{{  $contact->phone1 }}" data-display="{{  $contact->phone1 }}" data-paid="{{  $contact->phone1 }}" class="phone button button--secondary">Call <span class="number">  {{  $contact->phone1 }} </span></a>

	<a   class="button button--secondary button--separator" href="tel:{{  $contact->phone2 }}" ><span class="or">or </span>{{  $contact->phone2 }} </a>
</div>
</div>
  </div>
