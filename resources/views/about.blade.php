...
<div class="panels">
  ...
  <div class="panel background--lightgray" id="panel--45">
        <div class="layout-container">
                        <h2>
            <div class="field field--name-field-panel-header field--type-string field--label-hidden field__item">{{  $page->title  }} </div>
      </h2>
...
{!!   $page->body  !!}
  ...
  <div class="panel background--black" id="panel--51">
            ...
            <div class="field field--name-field-panel-bg-image field--type-entity-reference field--label-hidden field__item"><div class="banner-image banner-background" style="background-image:url('{{asset('img/logo.jpg')}}');">
</div></div>
