            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
               ...
               <a   class="btn btn-primary" href="/pages">  pages List     </a>
                <form  method="post" action="@if(isset($page)) /pages/{{ $page->id }}  @else /pages @endif"   >
                 
                  {{ csrf_field() }}
              
                  <div class="form-group">
                    <label>Page Title</label>
                    <input   type="text" class="form-control" placeholder="page Title" value="@if(isset($page)) {{$page->title}} @endif"   name="title" >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="checkbox">
                   ...
                   <input       type="file"   style="display: none"    id="file-article" name="picture"   class="file-article" >
                  </div>
